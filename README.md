...
- Diff-based code editing: model returns structured <<<FIND>>><<<REPLACE>>><<<END>>> blocks instead of a full file regeneration. 
- Full user system: A general purpose LLM interface for chatting and experimenting.
...
3. Navigaet into the project folder:
   cd RASMUS-main
